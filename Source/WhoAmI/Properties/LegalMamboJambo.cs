...
namespace WhoAmI
{
	public static class LegalMamboJambo
	{
		...
		public const string Copyright = "Copyright © 2024 LisiasT";
		public const string Product = "Who Am I? /L";
		public const string Trademark = "WhoAmI™ by RealGecko, maja, LisiasT";
	}
}
